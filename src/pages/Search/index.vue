        ...
        <div class="details clearfix">
          ...
          <div class="goods-list">
            <ul class="yui3-g">
              ...
              <!--          分页器-->
            <Pagination :pageNo="searchParams.pageNo" :pageSize="searchParams.pageSize" :total="total" :continues="5" @getPageNum="getPageNum"></Pagination>
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods:{
    ...
    removeCategoryName(){
      //把带给服务器的参数置空后 再次发送请求
      //带给服务器的参数说明 可有可无：如果属性值为空，字符串还是会把相应的字段带给服务器
      //响应字段变为undefined，不会带给服务器
      this.searchParams.categoryName = undefined;
      this.searchParams.category1Id = undefined;
      this.searchParams.category2Id = undefined;
      this.searchParams.category3Id = undefined;
      this.getData();
      //地址栏也需要修改，进行路由跳转(删除query参数 保留params参数，跳转自己本身)
